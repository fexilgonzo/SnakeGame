...
# game over function
def game_over():
    # create a font object my_font
    my_font = pygame.font.SysFont('time new roman', 50)

    # create a new text surface on which text will be drawn
    ...
    # blit will draw the test on the screen
...
while True:
    ...
    # If two keys are pressed simultaneously, we don't want snake to 
    # move into two directions simultaneously.
